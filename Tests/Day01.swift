...
final class Day01Tests: XCTestCase {
  ...
  func testPart1() throws {
    ...
    XCTAssertEqual(String(describing: challenge.part1()), "54968")
  }
  ...
  func testStrings() throws {
    ...
    for value in 0..<10 {
//            let value = Int(slice)
        XCTAssertEqual( value, to_number(input:numbers[value]))
        XCTAssertEqual( value, to_number(input:letters[value]))
//        XCTAssertEqual( value, to_number(input:numbers[value]+letters[value]))
    }
  }
}
